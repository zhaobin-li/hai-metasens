...
df <- tribble(
  ...
  n, 0.6, 0.9, 2, 1, 1, .5, 2, 1, 1, .5,
  n, 0.5, 0.3, 2, 1, 1, .5, 2, 1, 1, .5,
  n, 0.6, 0.9, 5, 1, 1, .2, 5, 1, 1, .2,
  n, 0.5, 0.3, 5, 1, 1, .2, 5, 1, 1, .2,
  n, 0.6, 0.9, 10, 2.7, 1, .9, 2, .3, 1, .1,
  n, 0.5, 0.3, 10, 2.7, 1, .9, 2, .3, 1, .1,
  n, 0.6, 0.9, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.9, 0.6, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.5, 0.3, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.3, 0.5, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.1, 0.9, 2, 1, 1, .5, 2, 1, 1, .5,
  n, 0.5, 0.7, 2, 1, 1, .5, 2, 1, 1, .5,
  n, 0.1, 0.9, 5, 1, 1, .2, 5, 1, 1, .2,
  n, 0.5, 0.7, 5, 1, 1, .2, 5, 1, 1, .2,
  n, 0.1, 0.9, 10, 2.7, 1, .9, 2, .3, 1, .1,
  n, 0.5, 0.7, 10, 2.7, 1, .9, 2, .3, 1, .1,
  n, 0.1, 0.9, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.9, 0.1, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.5, 0.7, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.7, 0.5, 1, .2, .1, 1, 4, .2, .2, 1,
  n, 0.6, 0.9, 1, .5, -2, 1, 2, 1, -1, .5,
  n, 0.5, 0.3, 1, .5, -2, 1, 2, 1, -1, .5,
  n, 0.6, 0.9, -1, 1, -5, .2, -1, 1, -5, .2,
  n, 0.5, 0.3, -1, 1, -5, .2, -1, 1, -5, .2,
  n, 0.6, 0.9, 1, .9, -10, 2.7, 2, .3, 1, .1,
  n, 0.5, 0.3, 1, .9, -10, 2.7, 2, .3, 1, .1,
  n, 0.6, 0.9, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.9, 0.6, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.5, 0.3, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.3, 0.5, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.1, 0.9, 1, .5, -2, 1, 2, 1, -1, .5,
  n, 0.5, 0.7, 1, .5, -2, 1, 2, 1, -1, .5,
  n, 0.1, 0.9, -1, 1, -5, .2, -1, 1, -5, .2,
  n, 0.5, 0.7, -1, 1, -5, .2, -1, 1, -5, .2,
  n, 0.1, 0.9, 1, .9, -10, 2.7, 2, .3, 1, .1,
  n, 0.5, 0.7, 1, .9, -10, 2.7, 2, .3, 1, .1,
  n, 0.1, 0.9, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.9, 0.1, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.5, 0.7, 1, .2, -.1, 1, 4, .2, -.2, 1,
  n, 0.7, 0.5, 1, .2, -.1, 1, 4, .2, -.2, 1,
